...
incidencia <- read_csv("/Users/patatas/Documents/aritzy/mujeres/incidencia delictiva/datos/Municipal-Delitos-2015-2024_nov2024/Municipal-Delitos-2015-2020_dic2020.csv",
...
tabla_expl <-  victimas %>% 
  select(`Tipo de delito`, Sexo) %>% 
  count(`Tipo de delito`, Sexo) 


tabla_expl <-  tabla_expl %>% 
  select(`Tipo de delito`, Sexo) 

pob_intercensal2015 <- read_csv("poblacion_nacional_2015.csv")
